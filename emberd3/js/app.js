    ...
    goValue: function(){
     ...
     goif: function(){
      ...
      $('.table td').on('change', function(evt, newValue) {
        ...
        if((tableDatas[index].value>0 && index!=0 )|| index==table.rows[1].cells.length-1) {newbarValues=[];alert("You can't change values for cumnulative bars");return false;}
